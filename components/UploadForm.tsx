              ...
              <div className="space-y-2">
                ...
                <div
                  className={`upload-dropzone border-2 border-dashed border-[#d4c4a8] ${
                    field.value ? "upload-dropzone-uploaded border-transparent" : ""
                  }`}
                  onClick={() => {
          ...
          <Controller
            ...
            render={({ field }) => (
              <div className="space-y-4">
                ...
                <div className="space-y-4">
                  <div>
                    <h4 className="text-sm font-medium text-[#3d485e] mb-2 uppercase tracking-wider">Male Voices</h4>
                    <div className="voice-selector-options flex-wrap">
                      {voices.male.map((voice) => (
                        ...
                        >
                          ...
                          <span className="text-sm text-[#3d485e]">{voice.description}</span>
                        </div>
                      ))}
                    </div>
                  </div>
                  ...
                  <div>
                    <h4 className="text-sm font-medium text-[#3d485e] mb-2 uppercase tracking-wider">Female Voices</h4>
                    <div className="voice-selector-options flex-wrap">
